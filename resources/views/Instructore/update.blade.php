                                                                                ...
                                                                                <div class="col-md-12">
                                                                                    <div class="p-3">
                                                                                        ...
                                                                                        <div class="form-group row my-2 ">
                                                                                            <div class="col-sm-12">
                                                                                                <input type="file" name="img" id="updateImage" onchange=" previewFile()" class="form-control m-auto">

                                                                                            </div>
                                                                                            <input type="hidden" value="{{$result->img}}" name="img1">
                                                                                        </div>
                                                                                        <br>
                                                                                        <img src="{{asset('/Instructore/img/'.$result->img)}}"class="w-100 "  id="image_preview"  style="height: 200px;" alt="">

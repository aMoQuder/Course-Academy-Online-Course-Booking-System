        ...
        <div class="section-area section-sp1">
            <div class="container">
                 <div class="row">
                    ...
                    @if( $instruct->id==$old_id)

                    <div class="col-lg-3 col-md-4 col-sm-12 m-b30">
                        <div class="profile-bx text-center">
                            <div class="user-profile-thumb">
                                <img src="{{ asset('/instructore/img/' . $instruct->img) }}" alt="" />
                            </div>
                            ...
                            <div class="profile-social">
                                <ul class="list-inline m-a0">
                                    <li><a href="{{ $instruct->facebook}}"><i class="fa fa-facebook"></i></a></li>
                                    <li><a href="#"><i class="fa fa-twitter"></i></a></li>
                                    <li><a href="{{ $instruct->linked_in}}"><i class="fa fa-linkedin"></i></a></li>
                                    <li><a href="{{ $instruct->linked_in}}"><i class="fa fa-instagram"></i></a></li>
                                </ul>
                            </div>
                                                ...
                                                <li class="action-card col-xl-4 col-lg-6 col-md-12 col-sm-6 publish">
                                                    <div class="cours-bx">
                                                        <div class="action-box">
                                                            ...
                                                            <a href="{{route("mycourse",$item->id)}}" class="btn">Read More</a>
                                                        </div>

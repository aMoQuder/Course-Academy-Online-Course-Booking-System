...
@section('content')
    ...
    <div class="page-content">
        ...
        <!-- Page Content Box ==== -->
        <!-- About Content ==== -->
        <img src="{{ asset('assets/images/background/bg1.jpg') }}" class="about-img"
            style="position: absolute;  z-index: -1; width: 100%;" alt="">
                    ...
                    <div class="modal-body  " style="direction: rtl;">
                        ...
                        <form action="">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="" id="" value="Enter Name"class="form-control my-3"
                                    aria-describedby="helpId">
                            </div>
                            <div class="form-group">
                                <textarea rows="5" cols="5" name="opinion" class="form-control"
                                    placeholder=" {{ __('language.add opinion') }}"></textarea>
                            </div>
                            <a href="{{route('login')}}" class="btn btn-outline-success my-3 px-4 py-2 rounded-1 ">
                                {{ __('language.add opinion') }}
                            </a>
                        </form>

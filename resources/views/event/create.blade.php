                            ...
                            <div class="col-sm-12">
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-block">
                                        <form enctype="multipart/form-data" action={{ route('events.store') }}
                                            method="POST">
                                            @csrf
                                            <div class="row">
                                                <div class="col-sm-12">
                                                ...
                                                <div class="col-md-12 mobile-inputs">
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-md-12">
                                                            <input type="id" placeholder="id" class="form-control "
                                                                name="id">
                                                            @error('id')
                                            ...
                                            <div class="form-group row">
                                                <label class="col-sm-2 col-form-label">title  event</label>
                                                <div class="col-sm-10">
                                                                                ...
                                                                                <div class="col-md-12">
                                                                                    <div class="p-3">
                                                                                        <img src="" class="w-100 " 
                                                                                            ...
                                                                                            alt="">
                                                                                        <h5 class="text-center my-2">this
                                                                                            img in bage Events </h5>
                                                                                        <br>
                                                                                        <div class="form-group row">
